    ...
    <section className="mb-12">
      <div className="flex items-center justify-between mb-6">
        ...
        <form action={generateApiKey}>
          <button className="bg-white/10 text-white backdrop-blur-xl border border-white/20 px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-white/20 transition-colors shadow-lg">
            + Create New Key
          </button>
        </form>
      </div>
